...
public class IntakeSubsystem extends SubsystemBase
{
    ...
    {
        intakeDeployPidController.setReference(desiredRotation, ControlType.kPosition);
        intakeRollerPidController.setReference(desiredVelocity, ControlType.kVelocity);
    }

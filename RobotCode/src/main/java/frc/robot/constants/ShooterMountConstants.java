...
public class ShooterMountConstants
{
	...
	public static final double SHOOTER_MOUNT_MIN_ANGLE = 0.35;
	...
	public static final double SHOOTER_MOUNT_AMP_ANGLE = 2.7;
	/** Angle in encoder ticks for shooting at speaker */
	public static final double SHOOTER_MOUNT_SPEAKER_ANGLE_FIXED = 2.7;

	public static final double SHOOTER_MOUNT_KP = 0.05; //0.4;

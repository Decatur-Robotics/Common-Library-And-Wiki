...
public class IntakeConstants {
    ...
    /** Ticks per second */
    public static final double INTAKE_DEPLOYED_VELOCITY = 5500;
    ...
    public static final double INTAKE_ROLLER_KP = 0; // 1;
    public static final double INTAKE_ROLLER_KI = 0;
    public static final double INTAKE_ROLLER_KD = 0; // 0.5;
    public static final double INTAKE_ROLLER_KFF = 0; // 14;
}

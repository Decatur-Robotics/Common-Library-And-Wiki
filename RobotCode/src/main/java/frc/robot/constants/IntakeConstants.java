...
public class IntakeConstants
{
    ...
    /** Ticks per second */
    public static final double INTAKE_DEPLOYED_VELOCITY = 1000;

    /** Ticks */
    public static final double INTAKE_RETRACTED_ROTATION = -5.81;
    /** Ticks */
    public static final double INTAKE_DEPLOYED_ROTATION = -0.02;
    ...
    public static final double INTAKE_ROLLER_KP = 0.05;
    public static final double INTAKE_ROLLER_KI = 0;
    public static final double INTAKE_ROLLER_KD = 0;
    public static final double INTAKE_ROLLER_KFF = 0.000;
}

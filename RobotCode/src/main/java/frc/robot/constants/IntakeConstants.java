...
public class IntakeConstants {
    ...
    public static final double INTAKE_DEPLOYMENT_UP_KP = 0.01; // 0.5;
    ...
    public static final double INTAKE_DEPLOYMENT_DOWN_KI = 0.01;
    public static final double INTAKE_DEPLOYMENT_DOWN_KD = 0.01;
    public static final double INTAKE_DEPLOYMENT_DOWN_KFF = 0.01;

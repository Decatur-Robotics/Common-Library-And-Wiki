...
im vport edu.wpi.first.wpilibj2.command.Command;
...
public class TankDriveCommand extends Command {
    ...
    public void execute() {
        ...
        finalLeftInputY = Math.pow(finalLeftInputY, TankDrivetrainConstants.DRIVETRAIN_POWER_EXPONENT);
        finalRightInputY = Math.pow(finalRightInputY, TankDrivetrainConstants.DRIVETRAIN_POWER_EXPONENT);
